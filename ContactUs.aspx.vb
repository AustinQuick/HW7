...
Partial Class ContactUs
    ...
    Protected Sub sendMail_Click(sender As Object, e As EventArgs) Handles sendMail.Click
        ...
        sendersEmail = tEmail.Text.ToString() 'capture the senders email from the textbox

        sendersMessage = tMessage.Text.ToString().Replace(Environment.NewLine, "<br />")   ' get the text from the message textbox keep text box formatting by replacing new lines (returns) with <br
        ...
        msg.ReplyToList.Add(sendersEmail) 'set the senders email address as the "reply to" for easy of sending a respons
